...
var fixtures = {
    simpleA:'./fixtures/simpleWithBracket/a.js',
    simpleB:'./fixtures/simpleWithBracket/b.js',
    simpleC:'./fixtures/simpleWithBracket/c.js'
};

var folders = {
    folderA: './fixtures/simpleWithBracket',
    simple: './fixtures/simpleWithBracket/**/*.js'
};

describe('Simple test case with bracket type of definition', function () {
    before(function () {
